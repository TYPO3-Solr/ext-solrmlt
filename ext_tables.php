...
if (!defined ('TYPO3_MODE')) {
   ...
   # ----- # ----- # ----- # ----- # ----- # ----- # ----- # ----- # ----- #
	...
	// TypoScript
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile($_EXTKEY, 'Configuration/TypoScript/MoreLikeThis/', 'Apache Solr - More Like This');
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue('solr_pi_mlt', 'FILE:EXT:solrmlt/Configuration/FlexForms/MoreLikeThis.xml');
